...
VALUES
    ...
    ('whitney houston', 'the bodyguard',1992,32400000,'R&B,Soul'),
    ('meat loaf', 'bat out of hell', 1977, 21700000, 'Hard rock'),
    ('eagles', 'their greatest hits', 1922, 41200000, 'country rock'),
    ...
    ('led zeppelin ','led zepplin iv', 1971, 14400000, 'hard rock'),
